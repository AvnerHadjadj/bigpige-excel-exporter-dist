...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AnnonceSearchResultModel", function() { return AnnonceSearchResultModel; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");

class AnnonceSearchResultModel {
}
;
...
let AppComponent = class AppComponent {
    ...
    ngOnInit() {
        Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["forkJoin"])(this.dataService.getAnnonces(), this.dataService.getRegions(), this.dataService.getCategories()).subscribe((res) => {
            this.data = res[0];
            this.regions = res[1];
...
/* harmony import */ var _AnnonceSearchResultModel__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./AnnonceSearchResultModel */ "./src/app/AnnonceSearchResultModel.ts");
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! rxjs */ "./node_modules/rxjs/_esm2015/index.js");
...
let DataService = class DataService {
    ...
    postFiltered(filtered) {
        return this.http.post(src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].api_host + "/annonces/recherche", filtered, {
            ...
            this.emitAnnonces(new _AnnonceSearchResultModel__WEBPACK_IMPORTED_MODULE_3__["AnnonceSearchResultModel"]());
        });
    }
    getRegions() {
