...
let AppComponent = class AppComponent {
    ...
    filterCategorie(query, categories) {
        let filtered = [];
    ...
    ngOnInit() {
        this.dataService.getAnnonces().subscribe((res) => { this.data = res; });
        this.dataService.getRegions().subscribe((res) => { this.regions = res; });
        this.dataService.getCategories().subscribe((res) => { this.categories = res.map(c => c.categorie); });
        this.fr = {
...
/* harmony import */ var primeng_accordion__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! primeng/accordion */ "./node_modules/primeng/fesm2015/primeng-accordion.js");
/* harmony import */ var primeng_slider__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! primeng/slider */ "./node_modules/primeng/fesm2015/primeng-slider.js");
...
let DataService = class DataService {
    ...
    getRegions() {
        return this.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].api_host + "/regions");
    }
    getCategories() {
        return this.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].api_host + "/annonces/categories");
    }
};
...
let TableComponent = class TableComponent {
    ...
    ngOnInit() {
        this.dataService.getAnnonces().subscribe((res) => { this.data = res.data; });
        this.cols = [
            { field: 'id', header: 'Id' },
...
module.exports = __webpack_require__(/*! /Users/avner/repositories/bigpige-excel-exporter/src/main.ts */"./src/main.ts");
