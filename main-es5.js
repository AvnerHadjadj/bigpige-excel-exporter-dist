    ...
    function () {
      ...
      _createClass(AppComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.dataService.getRegions().subscribe(function (res) {
            _this.regions = res;
          });
          this.dataService.getCategories().subscribe(function (res) {
            _this.categories = res.map(function (c) {
              return c.categorie;
            });
          });
          this.fr = {
        ...
        value: function onFilter() {
          var Region = this.filterForm.get('region').value;
          var Categorie = this.filterForm.get('categorie').value;
          var Ville = this.filterForm.get('ville').value;
          var CodePostal = this.filterForm.get('codePostal').value;
          var StartDate = this.filterForm.get('startDate').value;
          var StopDate = this.filterForm.get('stopDate').value;
          var RangeValues = this.filterForm.get('rangeValues').value;
      ...
      _createClass(TableComponent, [{
        ...
        value: function exportPdf() {
          ...
          "./node_modules/jspdf/dist/jspdf.min.js", 7)).then(function (jsPDF) {
            ...
            "./node_modules/jspdf-autotable/dist/jspdf.plugin.autotable.js", 7)).then(function (x) {
              ...
              doc.autoTable(_this3.exportColumns, _this3.data);
        ...
        value: function exportExcel() {
          ...
          "./node_modules/xlsx/xlsx.js", 7)).then(function (xlsx) {
            var worksheet = xlsx.utils.json_to_sheet(_this4.getData());
            var workbook = {
              Sheets: {
                'data': worksheet
              },
            ...
            _this4.saveAsExcelFile(excelBuffer, "primengTable");
          });
        }
      }, {
        key: "saveAsExcelFile",
